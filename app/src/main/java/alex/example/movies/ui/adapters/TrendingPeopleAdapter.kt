...
class TrendingPeopleAdapter(private val items: List<People>) :
    RecyclerView.Adapter<TrendingPeopleAdapter.TrendingPeopleItemViewHolder>() {
    ...
    override fun onBindViewHolder(
        holder: TrendingPeopleAdapter.TrendingPeopleItemViewHolder,
        position: Int
    ) {
