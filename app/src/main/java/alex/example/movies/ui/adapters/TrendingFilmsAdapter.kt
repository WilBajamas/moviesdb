...
class TrendingFilmsAdapter(private val items: List<Film>) :
    ...
    inner class TrendingFilmsItemViewHolder(val binding: ShowItemBinding) :
    ...
    override fun onBindViewHolder(holder: TrendingFilmsAdapter.TrendingFilmsItemViewHolder, position: Int) {
